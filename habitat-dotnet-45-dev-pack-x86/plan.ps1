$pkg_name="dotnet-45-dev-pack-x86"
$pkg_origin="chef"
$pkg_version="0.1.0"
...
$pkg_bin_dirs=@("Program Files\Microsoft SDKs\Windows\v8.0A\bin\NETFX 4.0 Tools\x86")
$pkg_lib_dirs=@("Program Files\Windows Kits\8.0\Lib\Win8\um\x86")
