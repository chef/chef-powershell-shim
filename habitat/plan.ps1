...
$pkg_build_deps=@(
  "core/nuget",
  "core/dotnet-481-dev-pack/4.8.1/20240902051613", #, As of August 2024, this package should be installed by default on all Windows devices.
  "core/windows-11-sdk/10.0.22621/20240809042940", 
